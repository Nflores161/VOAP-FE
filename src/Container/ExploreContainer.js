    ...
    return (
        ...
        >
          <Tab
            ...
            className="user-tab"
          >
            <div style={{display: "flex", flexDirection:"column", justifyContent: "space-around", alignItems: "center",margin: "5em"}}>
              
              <h1 style={{fontSize: '3em'}}>Explore artists by the music genre that best fits   <span style={{color: "red", fontFamily: 'Permanent Marker', fontSize: '2em'}}> your</span> search for the perfect art... </h1>
